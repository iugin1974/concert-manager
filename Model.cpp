...
void Model::updateConcertInfo(const Concert &updated, Concert &concert) {
	concert.setTitle(updated.getTitle());
	concert.setPlaces(updated.getPlaces());
	concert.setDatesAsString(updated.getDatesAsString());
}
